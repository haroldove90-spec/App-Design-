...
export default function HeroSlider({ onQuoteClick }: HeroSliderProps) {
  ...
  return (
    <section id="inicio" className="relative min-h-screen pt-28 pb-16 flex items-center bg-slate-950 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 w-full relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col items-start text-left">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-900/30 border border-blue-500/30 text-blue-400 font-mono text-xs mb-6 uppercase tracking-wider"
          >
          ...
          <motion.h1
            ...
            id="hero-main-title"
          >
            Transformamos tus <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-blue-500 to-indigo-500">ideas</span> en soluciones de alto impacto.
          </motion.h1>
          ...
          >
            <button
              ...
              className="bg-blue-600 text-white hover:bg-blue-500 px-8 py-4 rounded-xl font-semibold flex items-center justify-center gap-3 transition-all hover:scale-[1.02] shadow-xl shadow-blue-500/20 active:scale-95 cursor-pointer"
              id="hero-primary-cta"
            >
        ...
        <div className="lg:col-span-5 relative" id="hero-image-slider">
          <motion.div
            ...
            className="relative bg-gradient-to-b from-blue-950/40 to-slate-950/40 p-3 rounded-2xl border border-blue-900/30 overflow-hidden shadow-2xl shadow-blue-500/5 group"
          >
            ...
            <div className="aspect-[4/5] rounded-xl overflow-hidden relative">
              ...
              >
                ...
                <g opacity="0.3" transform="translate(40, 60)">
                  <rect x="0" y="0" width="120" height="6" rx="3" fill="#1053f3" />
                  <rect x="0" y="15" width="80" height="6" rx="3" fill="#3b82f6" />
                  <rect x="0" y="30" width="100" height="6" rx="3" fill="#818cf8" />
                </g>
                ...
                <g transform="translate(180, 110)">
                  ...
                  {/* Phone body */}
                  <rect x="-4" y="-4" width="160" height="300" rx="24" fill="#090d16" stroke="#2563eb" strokeWidth="3" />
                  ...
                  {/* App UI content */}
                  <circle cx="76" cy="65" r="24" fill="#1e3a8a" />
                  <path d="M 68 65 L 84 65 M 76 57 L 76 73" stroke="#60a5fa" strokeWidth="3" strokeLinecap="round" />
                  
                  {/* App stats charts */}
                  <rect x="20" y="115" width="112" height="12" rx="6" fill="#1e293b" />
                  <rect x="20" y="115" width="70" height="12" rx="6" fill="#3b82f6" />
                  
                  {/* Dynamic grid widgets */}
                  <rect x="20" y="140" width="52" height="45" rx="8" fill="#1053f3" opacity="0.8" />
                  ...
                  <text x="32" y="228" fill="#38bdf8" fontSize="11" fontWeight="bold" fontFamily="sans-serif">+$24,850 MXN</text>
                ...
                <g transform="translate(45, 190)">
                  ...
                  {/* Brochure Cover */}
                  <rect x="-2" y="-2" width="125" height="180" rx="12" fill="#1e293b" stroke="#3b82f6" strokeWidth="2" transform="rotate(-6 62 90)" />
                  <rect x="4" y="4" width="113" height="168" rx="8" fill="#f8fafc" transform="rotate(-6 62 90)" />
                  
                  {/* Branding elements on printed material */}
                  <path d="M 12 42 L 55 12" stroke="#1053f3" strokeWidth="8" strokeLinecap="round" transform="rotate(-6 62 90)" />
                  <circle cx="28" cy="74" r="14" fill="#3b82f6" transform="rotate(-6 62 90)" />
                ...
                <defs>
                  <linearGradient id="blue-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" stopColor="#1053f3" />
              ...
              <div className="absolute bottom-4 left-0 right-0 z-20 flex justify-between items-center px-4">
                <div className="flex gap-2">
                  <span className="w-6 h-1.5 rounded-full bg-blue-500 block transition-all" />
            ...
            {/* Glowing outer aura */}
            <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-2xl blur-md opacity-25 group-hover:opacity-45 transition duration-500 -z-10" />
          </motion.div>
        </div>
      </div>
    </section>
